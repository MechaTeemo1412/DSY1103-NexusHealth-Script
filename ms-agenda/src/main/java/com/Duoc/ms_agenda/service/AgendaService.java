...
import com.Duoc.ms_agenda.repository.AgendaRepository;
...
public class AgendaService {
    ...
    public Optional<Cita> obtenerPorId(Long id){
        Optional<Cita> cita = agendaRepository.findById(id);
        if(cita.isPresent()){
            enviarLogAuditoria("CONSULTA_AGENDA", "Se consultó exitosamente la cita ID: " + id);
        }
        return cita;
    }
